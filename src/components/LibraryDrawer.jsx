    ...
    <>
      ...
      <div className={styles.drawer}>
        <div className={styles.header}>
          <h2>Bibliothèque</h2>
          <button className={styles.closeBtn} onClick={onClose} aria-label="Fermer la bibliothèque">
            <X size={16} />
          </button>
        </div>
          ...
          {activeTab === 'history' && (
            localHistory.length === 0 ? (
              <div className={styles.empty}>
                ...
                <span className={styles.emptySub}>Les titres écoutés apparaîtront ici</span>
              </div>
            ) : (
                ...
                <div key={trackKey(track)} className={styles.item} onClick={() => play(track)}>
                  ...
                  <div className={styles.info}>
                    ...
                    <span className={styles.meta}>
                      <span className={styles.tag}>Écouté</span>
                    </span>
                  </div>
                </div>
              ))
          ...
          {activeTab === 'playlists' && (
            playlists.length === 0 ? (
              <div className={styles.empty}>
                ...
                <p>Aucune playlist</p>
                <span className={styles.emptySub}>Crée ta première playlist</span>
              </div>
            ) : (
