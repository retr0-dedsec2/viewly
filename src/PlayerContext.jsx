...
export const TRACKS = [
  ...
  { id: 5, title: 'Dernière Danse', artist: 'Indila', duration: 212, emoji: '💃', youtubeId: 'K5KAc5CoCuk', gradient: 'linear-gradient(135deg,#19a27b,#14335e)', tag: 'French touch' },
  ...
  { id: 7, title: 'Je veux', artist: 'ZAZ', duration: 220, emoji: '🎙️', youtubeId: '0TFNGRYMz1U', gradient: 'linear-gradient(135deg,#10a37f,#16305a)', tag: 'Live vibe' },
